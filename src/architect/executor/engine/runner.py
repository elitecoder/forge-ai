...
4. Write `{state.session_dir}/code-checklist.json` with a summary of changes.
5. Run this bash command: `python3 {PIPELINE_CLI} pass code`

Step 5 is mandatory. If you do not run it, all your work is discarded.
"""
